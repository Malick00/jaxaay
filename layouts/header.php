				...
				<div class="topbar-info">
					<ul>
						...
						<li>
							...
							<div class="topbar-text">
								<span>Ouverte: Lun - Ven 8h.00 à 16h.00</span>
							</div><!-- topbar-text -->
						</li><!-- li -->
					</ul>
                    <!-- ul -->
	...
	<div class="main-menu sticky-header">
		<div class="main-menu-inner">
			<div class="main-menu-left">
				<div class="main-menu-logo" style='background-color:transparent'>
					<a href="index.html"><img src="assets/image/logo.png" alt="img-145" width="80" height="60"></a>
				</div>
                <!--main-menu-logo-->
