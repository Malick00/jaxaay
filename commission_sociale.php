...
<head>
	...
	<title>commission sociale culturelle & éducative</title>
</head>
<body>
<!-- Pre loader -->
<div id="pre-loader">
	...
	<!--<section class="page-banner">
		<div class="container">
			...
			<div class="page-banner-title">
				<h3 style='color:#003b49;'>Sociale Culturelle & Éducative</h3>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="department-details-imgbox">
						<img src="assets/image/department/comsociale-1.jpg" class="img-fluid" alt="img-159">
						<a href="#"></a>
					...
					<div class="department-details-content-box">
						<h4 class="department-details-title">Commission Sociale Culturelle & Éducative</h4>
					...
					<div class="department-details-box">
						<div class="department-details-policy">
							<span>We stand for quality, safety & credibility, so you could be trust us fully about private jet charters and our working process.</span><!-- span -->
						</div><!-- department-details-policy -->
						...
						<div class="row row-gutter-30">
							<div class="col-lg-6">
								<div class="department-details-benefits-box-image">
									<img src="assets/image/department/mission.png" class="img-fluid" alt="160">
					...
					</div><!-- department-details-benefits-inner-box -->
					...
					<!--<div class="department-details-skill-box">
						<div class="row">
							...
							<!-- </div>col-12 col-lg-6 -->
						<!-- </div>row -->
					<!-- </div>department-details-skill-box -->
