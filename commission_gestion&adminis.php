...
<head>
	...
	<title>commission gestion & administration</title>
</head>
<body>
<!-- Pre loader -->
<div id="pre-loader">
	...
	<!--<section class="page-banner">
		<div class="container">
			...
			<div class="page-banner-title">
				<h3 style='color:#003b49;'>Gestion & Administration</h3>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="department-details-imgbox">
						<img src="assets/image/department/comgestion-1.jpg" class="img-fluid" alt="img-159">
						<a href="#"></a>
					...
					<div class="department-details-content-box">
						<h4 class="department-details-title">Commission Gestion & Administration</h4>
